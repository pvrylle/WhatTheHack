        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center max-w-4xl mx-auto">
            <div className="mb-6">
              <Badge
                variant="outline"
                className="bg-primary/10 text-primary border-primary/30 font-mono mb-4"
              >
                ▸ SYSTEM ONLINE
              </Badge>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Button
                asChild
                size="lg"
                className="bg-primary hover:bg-muted hover:text-muted-foreground text-primary-foreground font-mono px-8"
              >
                <Link href="/auth">
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="border-secondary/30 text-secondary hover:bg-secondary/10 font-mono px-8"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {features.map((feature, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="border-border/50 bg-card/80 backdrop-blur hover:border-primary/50 transition-all duration-300 group"
                >
                  <CardHeader className="text-center">
                    <div
                      className={`mx-auto mb-4 p-4 rounded-lg bg-${feature.color}/20 border border-${feature.color}/30 w-fit group-hover:scale-110 transition-transform`}
                    >
            ...
            <CardContent className="p-12 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button
                  asChild
                  size="lg"
                  className="bg-accent hover:bg-accent/90 text-accent-foreground font-mono px-8"
                >
                  <Link href="/dashboard">
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="border-primary/30 text-primary hover:bg-muted hover:text-muted-foreground font-mono px-8"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground font-mono">
                Master ethical hacking through hands-on cybersecurity challenges and real-world
                scenarios.
              </p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2 text-sm">
                <Link
                  href="/challenges/web-security"
                  className="block text-muted-foreground hover:text-primary transition-colors"
                >
                  Web Security
                </Link>
                <Link
                  href="/challenges/network-exploitation"
                  className="block text-muted-foreground hover:text-primary transition-colors"
                >
                  Network Security
                </Link>
                <Link
                  href="/challenges/cryptography"
                  className="block text-muted-foreground hover:text-primary transition-colors"
                >
                  Cryptography
                </Link>
                <Link
                  href="/challenges/database-security"
                  className="block text-muted-foreground hover:text-primary transition-colors"
                >
                  Database Security
                </Link>
