    ...
    <div className="container mx-auto px-6 py-8 space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary/5 via-background to-secondary/5 p-8 border border-primary/10">
        <div className="relative z-10">
          ...
          <h1 className="text-4xl font-orbitron font-bold glow-text mb-2">Your Achievements</h1>
          <p className="text-muted-foreground text-lg max-w-2xl font-mono">
            Celebrate your cybersecurity milestones and track your progress on the global
            leaderboard
          </p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-6 text-center hover:shadow-md transition-shadow border-border/50 bg-card/80 backdrop-blur">
          ...
          <div className="text-2xl font-bold font-orbitron">{totalPoints.toLocaleString()}</div>
          <div className="text-sm text-muted-foreground font-mono">Total Points</div>
        </Card>
        ...
        <Card className="p-6 text-center hover:shadow-md transition-shadow border-border/50 bg-card/80 backdrop-blur">
          ...
          <div className="text-sm text-muted-foreground font-mono">Global Rank</div>
        </Card>
      </div>
          ...
          <section>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-semibold font-orbitron">Recently Earned</h2>
              </div>
                          ...
                          <div className="flex-1">
                            <div className="flex items-center justify-between mb-2">
                              ...
                              <div className="flex items-center gap-2">
                                <Badge className={styles.badge}>{achievement.rarity}</Badge>
          ...
          <section>
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl font-semibold font-orbitron">In Progress</h2>
              </div>
            ...
            <CardContent className="space-y-4">
              {[
                ...
                <div key={category.name} className="space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-sm font-medium font-mono">{category.name}</span>
              ...
              <button className="w-full p-3 text-left rounded-lg border border-dashed border-secondary/30 hover:border-secondary/50 hover:bg-secondary/5 transition-all group">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-muted-foreground font-mono">Compare progress</div>
                  </div>
                </div>
              </button>
            </CardContent>
